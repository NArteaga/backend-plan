...
let items = [
  ...
  { id: 2, nombre: 'Acciones', ruta: 'acciones', icono: 'fact_check', orden: 1, id_menu: null, estado: 'ACTIVO'  },
  { id: 3, nombre: 'Temas', ruta: 'temas', icono: 'fact_check', orden: 2, id_menu: null, estado: 'ACTIVO'  },
  { id: 4, nombre: 'Reuniones', ruta: 'reuniones', icono: 'fact_check', orden: 3, id_menu: null, estado: 'ACTIVO'  },
  { id: 5, nombre: 'Roles', ruta: 'roles', icono: 'fact_check', orden: 4, id_menu: null, estado: 'ACTIVO'  },
  { id: 6, nombre: 'Usuarios', ruta: 'usuarios', icono: 'people', orden: 5, id_menu: null, estado: 'ACTIVO'  },
  { id: 7, nombre: 'Menus', ruta: 'menus', icono: 'people', orden: 6, id_menu: null, estado: 'ACTIVO'  }
